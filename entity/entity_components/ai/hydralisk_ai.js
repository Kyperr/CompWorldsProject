function HydraliskAI(entity, viewDistance, attackDistance, attacksPerSecond, movementSpeed) {
    AI.call(this, entity);
...
HydraliskAI.prototype = new AI();
HydraliskAI.prototype.constructor = BasicEnemyAI;

HydraliskAI.prototype.update = function () {
...
HydraliskAI.prototype.moveTowards = function (tX, tY) {
...
HydraliskAI.prototype.attack = function (delta) {
